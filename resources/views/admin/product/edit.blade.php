                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="price"
                                                ...
                                                class="form-control border-0 shadow-sm" step="0.01" required>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" name="discount"
                                                ...
                                                class="form-control border-0 shadow-sm" step="0.01">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="size" name="size[]" class="form-control border-0 shadow-sm select2" multiple>
                                                @php $sizes = old('size', json_decode($product->size ?? '[]')); @endphp
                                                ...
                                                <option value="XL" {{ in_array("XL", $sizes) ? "selected" : "" }}>X-Large</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="description" class="form-control border-0 shadow-sm" rows="4">{{ old('description', $product->description) }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <img src="{{ Storage::url($product->image) }}" width="120" class="mb-2 rounded">
                                            @endif
