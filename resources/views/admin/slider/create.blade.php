            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Add Slider</li>
                    </ol>
                </nav>
                        ...
                        <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title" class="form-control border-0 shadow-sm" placeholder="Enter Slider title" required>
                                </div>

                                <!-- Subtitle -->
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Subtitle</label>
                                    <input type="text" name="subtitle" class="form-control border-0 shadow-sm" placeholder="Enter Slider subtitle">
                                </div>

                                <!-- Summary -->
                                <div class="col-12">
                                    <label class="form-label fw-bold">Summary</label>
                                    <textarea name="summary" class="form-control border-0 shadow-sm" rows="4" placeholder="Write a short summary..."></textarea>
                                </div>
