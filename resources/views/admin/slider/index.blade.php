    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
            <div class="d-flex justify-content-end mb-3 mt-4">
                <a href="{{ route('admin.slider.create')}}" class="btn btn-success btn-sm me-3">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs text-secondary mb-0">{{ $slider->subtitle }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs text-secondary mb-0">{{ $slider->summary }}</p>
                                            </td>
                                            <td>
                                                @if($slider->image)
