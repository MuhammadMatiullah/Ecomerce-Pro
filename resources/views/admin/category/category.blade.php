                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs text-secondary mb-0">Devices and gadgets</p>
                                            </td>
                                            <td>
                                                <span class="badge bg-gradient-secondary">electronics</span>
                                            </td>
                                            <td>
                                                <img src="{{asset('/assets/admin1/assets/img/default.png')}}" class="avatar avatar-sm me-3 border-radius-lg" alt="category">
                                            </td>
                                            <td class="align-middle text-center">
                                                <a href="#" class="text-warning font-weight-bold text-xs me-2">Edit</a>
                                                <a href="#" class="text-danger font-weight-bold text-xs">Delete</a>
                                            </td>
                                        </tr>
                                        <!-- End Example -->
                                    </tbody>
