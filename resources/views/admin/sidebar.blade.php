<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href="{{ url('/admin') }}" target="_blank">
        <img src="{{asset('assets/admin1/assets/img/logo-ct-dark.png')}}" class="navbar-brand-img" width="26" height="26" alt="main_logo">
